-- Historical schema fixture v5 (durable mutation substrate, commit 2208f2a).
...
CREATE TABLE operation_runs (
        ...
        created_at TEXT NOT NULL,
        updated_at TEXT NOT NULL
      , operation_json TEXT NOT NULL DEFAULT '{}' CHECK (json_valid(operation_json)), reconciled_at TEXT, reconciliation_json TEXT CHECK (reconciliation_json IS NULL OR json_valid(reconciliation_json)), capability_hash TEXT);
