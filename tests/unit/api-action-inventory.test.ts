...
const ADMINISTRATION_ANNOTATIONS: readonly ExpectedActionAnnotation[] = [
  ...
  apiAnnotation({
    ...
    availability: API_KEY_ONLY,
    materialFields: [
      materialField("/name", "Webhook name", "text", true),
      materialField("/url", "Webhook URL", "text", true),
      materialField("/webhookEvent", "Event type", "text", true),
      materialField("/triggerSourceType", "Trigger source type", "text", false),
      {
        kind: "array_item",
  ...
  apiAnnotation({
    ...
    materialFields: [
      ...
      materialField("/url", "Webhook URL", "text", false),
      materialField("/webhookEvent", "Event type", "text", false),
      materialField("/triggerSourceType", "Trigger source type", "text", false),
      {
        kind: "array_item",
        containerPath: "/triggerSource",
...
const INVOICE_ANNOTATIONS: readonly ExpectedActionAnnotation[] = [
  ...
  },
  {
    ...apiAnnotation({
      ...
      access: "write",
      sourceModule: "invoices.ts",
      support: [STRUCTURE_ENDPOINT.clients.list, INVOICE_ENDPOINT.list],
      availability: AVAILABLE_TO_BOTH_AUTH_CLASSES,
      materialFields: [
        materialField("/base/clientId", "Client", "entity", true),
        materialField("/base/number", "Invoice number", "text", true),
        materialField("/base/issuedDate", "Issued date", "text", true),
        materialField("/base/dueDate", "Due date", "text", true),
        materialField("/base/currency", "Currency", "text", true),
      ],
    }),
  ...
  },
  {
    ...apiAnnotation({
      ...
      materialFields: [
        ...
        materialField("/patch/number", "Invoice number", "text", false),
        materialField("/patch/issuedDate", "Issued date", "text", false),
        materialField("/patch/dueDate", "Due date", "text", false),
        materialField("/patch/currency", "Currency", "text", false),
        materialField("/patch/note", "Note", "text", false),
        materialField("/patch/subject", "Subject", "text", false),
        materialField("/patch/clientId", "Client", "entity", false),
        materialField("/patch/taxPercent", "Tax percent", "number", false),
        materialField("/patch/tax2Percent", "Tax 2 percent", "number", false),
        materialField("/patch/discountPercent", "Discount percent", "number", false),
      ],
    }),
    primaryMutationCount: 1,
    compensationCount: 0,
  ...
  },
  {
    ...apiAnnotation({
      ...
      materialFields: [
        materialField("/invoiceId", "Invoice", "entity", true),
        materialField("/from", "From date", "text", true),
        materialField("/to", "To date", "text", true),
        {
          kind: "array_item",
...
const TIME_OFF_APPROVAL_ANNOTATIONS: readonly ExpectedActionAnnotation[] = [
  ...
  }),
  {
    ...apiAnnotation({
      ...
      availability: AVAILABLE_TO_BOTH_AUTH_CLASSES,
      materialFields: [
        materialField("/name", "Policy name", "text", true),
        materialField("/requiresApproval", "Requires approval", "boolean", false),
        materialField("/daysPerYear", "Days per year", "number", false),
        materialField("/negativeBalance", "Negative balance", "boolean", false),
        {
          kind: "array_item",
          containerPath: "/userIds",
          itemPath: "/userId",
