...
describe("built release artifact identity", () => {
  it("binds the exact Git candidate, archive, and complete server artifact tree", () => {
  ...
  it("rejects any server artifact byte changed after the deterministic manifest was written", () => {
    const fixture = releaseFixture();
