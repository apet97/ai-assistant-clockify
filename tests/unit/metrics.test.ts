...
describe("buildMetrics", () => {
  ...
  it("summarizes confirmation outcomes (used→confirmed; executing rolled into pending)", () => {
    const m = buildMetrics([], ["used", "used", "cancelled", "expired", "failed", "pending", "executing"], "t");
