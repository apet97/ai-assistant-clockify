...
export const READ_PARITY_BASE_SEED: FakeWorkspaceSeed = {
  ...
  expenses: [{ id: "exp1", name: "Travel", notes: "Travel", total: 5000, date: "2026-06-05T12:00:00.000Z" }],
  ...
  assignments: [{ id: "a1", userId: "admin-1", projectId: "p1", start: "2026-06-01", end: "2026-06-30" }],
  approvals: [],
