...
- [`release-candidate.md`](./release-candidate.md) - version 1.0.0 engineering evidence
...
The release is ready for the three admin-only packages only when every engineering row
...
evidence-only descendant validation.
